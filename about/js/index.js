(function() {
  ...
  MESSAGES.push({
    delay: 2200,
    text: "We are a full stack development company specializing on Web and mobile development."
  });

  MESSAGES.push({
    delay: 3600,
    text: "Our team with our employees have started their activity since 2007, but as a company “ITResources” was founded 17.11.13."
  });

  MESSAGES.push({
    delay: 5200,
    text: "We have programmers who have more than 12 years’ experience. We provide our customers with solutions to their needs, offering the best cost-benefit service in developing the software for their organization ."
  });

  MESSAGES.push({
    delay: 5200,
    text: "We care about your budget and timeline. No deadlocks – ever. Because we respect your had-earned money and value your time. "
  });
   MESSAGES.push({
    delay: 5200,
    text: "We have the responsibility, the commitment and a strong vocation of service in all the situations related to our clients. We are always available for you."
  });
   MESSAGES.push({
    delay: 5200,
    text: "Our mission is to provide quality technology services in an efficient and effective approach to achieve high customer satisfaction."
  });
    MESSAGES.push({
    delay: 5200,
    text: "Our pledge is to provide friendly, helpful service, to listen to your feedback and use it to assess and improve the services we offer,to accept responsibility and maintain high standards."
  });
